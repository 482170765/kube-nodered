<script type="text/javascript">
    RED.nodes.registerType('randomforest', {
        ...
        defaults: {
            name: {value:""},
            n_estimators : {value:"10", required:true},
        ...
        oneditprepare: function() {
            $("#node-input-n_estimators").val(this.n_estimators);
...
<script type="text/x-red" data-template-name="randomforest">
    ...
    <div class="form-row">
        <label for="node-input-n_estimators" id="n_estimators"
          ><i class="fa"></i>n_estimators
        </label>
