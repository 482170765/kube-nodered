v<script type="text/javascript">
    RED.nodes.registerType('model creator', {
        ...
        label: function() {
            return this.name || this.model_name || "model";
        },
...
<script type="text/x-red" data-template-name="model creator">
    <div class="form-row">
    ...
    <div id="validation-message-div" style="display: none;"></div>
...
<script type="text/x-red" data-help-name="model creator">
